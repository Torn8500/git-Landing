...
$(document).ready(function () {
    ...
    $('.to-scroll').on('click', function (e) {
        ...
        $('body,html').animate({scrollTop: $('.' + toBlock).offset().top - 20}, 1000);
    });
    ...
    var flag = 0;
    if (window.innerWidth <= 1023 && flag === 0) {
        flag = 1;
        $('.review-slider').slick({
            arrows: false,
            dots: true,
    ...
    $(window).on('resize', function (event) {
        if (event.target.innerWidth <= 1023 && flag === 0) {
            flag = 1;
            $('.review-slider').slick({
                arrows: false,
                dots: true,
        ...
        } else if (event.target.innerWidth > 1023 && flag === 1) {
            flag = 0;
